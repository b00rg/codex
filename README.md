...
### Acknowledgements
This project uses [simple-markdown-editor]([https://github.com/username/awesome-library](https://github.com/sparksuite/simplemde-markdown-editor)) for markdown editor support.
